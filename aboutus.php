...
<div class="header">
		<div class="logo">
			<h1><a href="index.php"><img src="Images/new logo.jpg" alt=""></a></h1>
		</div>
	</div>
</div>
</div>
...
<div class="cont_main">
	<div class="content">
		<img src="Images/about.png" height="70px"  />
			...
			<p><img src="Images/123.jpg" height="200px" style="margin-bottom:40px" /></a>Here we are with Blood Bank. Which  is the first product resulted out of the community welfare initiative called 'People Project' from uSiS Technologies. Universally, 'Blood' is recognized as the most precious element that sustains life. It saves innumerable lives across the world in a variety of conditions. Once in every 2- seconds, someone, somewhere is desperately in need of blood. More than 39 million units of blood components are transfused every year. The need for blood is great - on any given day, approximately 39,000 units of Red Blood Cells are needed. Each year, we could meet only up to 1% (approx) of our nation's demand for blood transfusion.</p>
...
<div class="footer">
	<div class="f_nav">
		...
		<div class="copy">
			<p class="title">© All Rights Reserved | Designed by Diksha & Devraj |</p>
		</div>
	<div class="clear"></div>
</div>
</div>
